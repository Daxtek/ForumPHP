		...
		<form name="formCategorie" action="" method="POST" onsubmit="return verifForm()">
			...
			<label for="idtitre"> Titre : </label>
				<!-- \W (autorisé tout les caratères spéciaux) -->
				<input class="form-control" type="text" id="idtitre" name="titre" size="20" maxlength="50" pattern="[A-Z]+[a-zA-Z0-9ÀÁÂÃÄÅàáâãäåÒÓÔÕÖØòóôõöøÈÉÊËèéêëÇçÌÍÎÏìíîïÙÚÛÜùúûüÿÑñ \W]{2,}" title="Veuillez renter un titre commencent par une majuscule, taille minimum 3 caractères" required > <br>
